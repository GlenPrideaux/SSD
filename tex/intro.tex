...
For the Hebrew scriptures (the Law, the Prophets and the Writings),
the 'standard' copies go by the name the ``Masoretic'' Text, or MT for
short. These are the copies that virtually all English translations
are based on, and many other translations, too. When Jerome translated
the Latin Vulgate in the late 4th century he did so from the MT copies that had been provided to him by Jewish scholars. For most of the Hebrew scriptures, these copies can be shown to be substantially faithful and correct. However, that is not the case with the Word concerning
...
reading from the Palestinian copies, but many remain uncorrected. The table below lists a few of the
...
\begin{tabular}{p{0.1\textwidth}p{0.25\textwidth}p{0.25\textwidth}p{0.3\textwidth}}\hline
  ...
  1 Sam 13:1&he reigned forty years&he reigned two years&Compare
                                                          Acts
                                                          13:21.\\
  ...
  2 Sam 15:7&at the end of four years&At the end of forty
                                       years&Compare 1 Kings 2:11, 1
                                              Chr 3:1--4\\
  2 Sam 21:8&five sons of Merab&five sons of Michal&Some English
                                                     translations
                                                     render the
                                                     the Palestinian text here
                                                     to avoid the
                                                     obvious error in
                                                     the MT. Compare 1
                                                     Sam 18:19, 2 Sam
...
for this edition. This edition is a translation into
English of these more faithful copies of this part of scripture.The
translation is based on the American Standard
Version of 1901, adjusted to match the Palestinian
copies and updated to more contemporary English. Despite best efforts, it is likely that there have been
some (hopefully minor)
differences between the Palestinian text and the ASV English that have been
overlooked.
...
``The word concerning Samuel, Saul and David'' as this is descriptive of the
content. 
...
majority of English language editions. 
