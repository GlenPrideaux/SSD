...
the World English Bible (British English edition) translation (broadly based on the MT, but with
  some deviation as noted above) in the right
column. Both translations are based on the American Standard
Version of 1901, with the left column adjusted to match the Palestinian
copies. Despite best efforts, it is likely that there have been
...
In the WEB British English edition this name is rendered as LORD or
GOD in all caps.
...
The World English Bible (British English edition) is published by eBible.org and can be found at
\href{https://ebible.org/find/show.php?id=eng-webbe}{https://ebible.org/find/show.php?id=eng-webbe}. It
...
\textbf{Right:} World English Bible (British English edition) based (mostly) on the Masoretic copies,
labelled {\small (WEB)}